...
OBJECT                       = SPICE_KERNEL
  ...
  KERNEL_TYPE                = FRAMES
  DESCRIPTION                = "Generic Lunar SPICE FK file specifying
lunar body-fixed frames associated with the high-precision Moon orientation
provided in Lunar binary PCK files, created by NAIF, JPL. "
