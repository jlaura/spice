...
The Clementine SPICE Data Archive
========================================================================
...
============
   ...
   This document provides an overview of the Deep Space Program Science
   Experiment (DSPSE), a.k.a. Clementine, SPICE data set, including a
   description of the directory structure. Additional documents
   included on this data set provide more details, especially the
   ``spiceds.cat'' dataset description and the various kernel-specific
   ``/data/*/*info.txt'' files.
   ...
   for the Clementine spacecraft. See the file ``mission.cat'' in the
   ``/catalog'' directory for a description of the mission and the file
   ...
   through the end time of the mission.
...
===============
   ...
   |  |
   |  +--[orbnum]          Directory containing orbit number files.
   |     |
   |     |-- orbinfo.txt   Description of orbit number files.
   |     +-- *.orb         ``periapsis-to-periapsis'' orbit number files.
   |
...
=================
   ...
   Data System Navigation and Ancillary Information Facility Node, Jet
